...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _blockchain_ledger_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blockchain/ledger.mjs */ \"./src/electron-app/blockchain/ledger.mjs\");\nvar _require=__webpack_require__(/*! electron */ \"electron\"),app=_require.app,BrowserWindow=_require.BrowserWindow,ipcMain=_require.ipcMain;var _require2=__webpack_require__(/*! path */ \"path\"),resolve=_require2.resolve;var _require3=__webpack_require__(/*! url */ \"url\"),format=_require3.format;var msgpack=__webpack_require__(/*! msgpack5 */ \"msgpack5\")();var mainWindow;var ledger=new _blockchain_ledger_mjs__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"mongodb://localhost:27017\");function createWindow(){mainWindow=new BrowserWindow({width:800,height:600,icon:resolve(__dirname,\"icon.png\"),webPreferences:{nodeIntegration:true}});mainWindow.setMenu(null);mainWindow.loadURL( true?format({hostname:\"localhost\",pathname:\"index.html\",protocol:\"http\",slashes:true,port:8080}):undefined);if(true){mainWindow.webContents.openDevTools();__webpack_require__(/*! devtron */ \"devtron\").install();__webpack_require__(/*! vue-devtools */ \"vue-devtools\").install()}mainWindow.on(\"closed\",function(){mainWindow=null})}app.on(\"ready\",function(){createWindow();mainWindow.webContents.on(\"did-finish-load\",function(){ledger.initialize(function(block){if(block.data!=null){mainWindow.webContents.send(\"new-block\",block)}mainWindow.webContents.send(\"notify-block\",block)},function(verify){mainWindow.webContents.send(\"verification\",verify)});ipcMain.on(\"push-block\",function(event,data){ledger.push(data)})})});app.on(\"window-all-closed\",function(){if(process.platform!==\"darwin\"){app.quit()}});app.on(\"activate\",function(){if(mainWindow===null){createWindow()}});\n\n//# sourceURL=webpack:///./src/electron-app/main.js?");
